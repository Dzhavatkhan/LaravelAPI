...
Route::middleware('auth:sanctum')->group(function() {
    Route::get('cart/{id}', [CartPayController::class, 'addCart'])->name('addCart');
    Route::get("deleteCart/{id}", [CartPayController::class, 'deleteCart'])->name('deleteCart');
    Route::get('addOrder/{id}', [CartPayController::class, "addOrder"])->name('addOrder');
